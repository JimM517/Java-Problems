...
// maximal rectangle
    ...
    public int[] minBitWiseArrayII(List<Integer> nums) {
...
class Node {
    ...
    // minimize max pair sum ->>>>> faster solution
    public int minPairSumTwo(int[] nums) {
    ...
    // 1984. min difference between highest and lowest of k scores
